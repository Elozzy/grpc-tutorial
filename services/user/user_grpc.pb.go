...
type UserServiceClient interface {
	...
	DeleteUser(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*StandardResponse, error)
}
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *UserID, opts ...grpc.CallOption) (*StandardResponse, error) {
...
type UserServiceServer interface {
	...
	DeleteUser(context.Context, *UserID) (*StandardResponse, error)
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *UserID) (*StandardResponse, error) {
